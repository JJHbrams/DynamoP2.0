...
if("TRUE" STREQUAL "TRUE")
  set(vehicle_SOURCE_PREFIX /home/mrjohd/Kinodynamic_ws/src/vehicle)
  set(vehicle_DEVEL_PREFIX /home/mrjohd/Kinodynamic_ws/devel)
  set(vehicle_INSTALL_PREFIX "")
  set(vehicle_PREFIX ${vehicle_DEVEL_PREFIX})
else()
  set(vehicle_SOURCE_PREFIX "")
  set(vehicle_DEVEL_PREFIX "")
  set(vehicle_INSTALL_PREFIX /home/mrjohd/Kinodynamic_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://moveit.ros.org/ " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'JJH <m@s.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vehicle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mrjohd/Kinodynamic_ws/src/vehicle/${idir}'.  ${_report}")
    endif()
