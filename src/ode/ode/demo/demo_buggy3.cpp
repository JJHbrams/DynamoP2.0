...
static void simLoop (int pause){
  ...
  dReal X_set = RAND_VAL(-50,50), Y_set = RAND_VAL(-50,50), YAW_set = RAND_VAL(-M_PI,M_PI), DELTA = -3.0;
  dReal speedA = RAND_VAL(-100.0,100.0), speedB = RAND_VAL(-100.0,100.0);
  dReal TIME_set = RAND_VAL(100, 5000);
